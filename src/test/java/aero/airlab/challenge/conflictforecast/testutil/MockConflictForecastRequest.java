...
public class MockConflictForecastRequest {
  ...
  public ConflictForecastRequest get(String jsonRequest) {
    //ConflictForecastRequest mockConflictForecastRequest = new ConflictForecastRequest()
    return null;
  }
}
